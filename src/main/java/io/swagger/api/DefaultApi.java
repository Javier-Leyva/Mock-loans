...
public interface DefaultApi {
    ...
    @ApiOperation(value = "Get loans for a customer", nickname = "gETLoans", notes = "Get all loans available for a customer", response = GetLoansDetailResponse.class, authorizations = {
        @Authorization(value = "JWTProfile", scopes = {
            @AuthorizationScope(scope = "loansdet.read", description = "Loan details static scope")
            })
    }, tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = GetLoansDetailResponse.class),
