...
import io.swagger.model.GetLoansDetailResponse;
...
@Controller
public class LoanIdApiController implements LoanIdApi {

    private static final Logger log = LoggerFactory.getLogger(LoanIdApiController.class);
