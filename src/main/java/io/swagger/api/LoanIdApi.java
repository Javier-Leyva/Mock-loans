...
@Validated
@Api(value = "{loan_id}", description = "the {loan_id} API")
@RequestMapping(value = "/loans")
public interface LoanIdApi {

    @ApiOperation(value = "Allows aplications to get the detail of a loan", nickname = "gETLoanDetail", notes = "Allows aplications to get the detail of a loan", response = GetLoanDetailResponse.class, authorizations = {
        @Authorization(value = "JWTProfile", scopes = {
            @AuthorizationScope(scope = "loansdet.read", description = "Loan details static scope")
            })
    }, tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = GetLoanDetailResponse.class),
