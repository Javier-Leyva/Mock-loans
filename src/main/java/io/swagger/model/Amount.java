...
public class Amount   {
  ...
  **/
   ...
   * @return currency
  **/
  @ApiModelProperty(example = "EUR", required = true, value = "Currency code.  The value is in the alpha-3 format defined in ISO 4217 (https://www.iso.org/iso-4217-currency-codes.html).")
  @NotNull
